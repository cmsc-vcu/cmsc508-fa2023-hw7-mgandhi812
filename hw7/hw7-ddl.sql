...
INSERT INTO skills (id, name, description, tag) values
    (1, 'kick boxing', 'visualize this!', 'Skill1'),
    (2, 'cooking', 'cooking following recipes', 'Skill2'),
    (3, 'baking', 'baking following recipes', 'Skill3'),
    (4, 'coding', 'coding in any language', 'Skill4'),
    (5, 'python coding', 'coding in python', 'Skill5'),
    (6, 'java coding', 'coding in java', 'Skill6'),
    (7, 'knitting', 'knitting anything', 'Skill7'),
    (8, 'crocheting', 'crocheting anything', 'Skill8');
